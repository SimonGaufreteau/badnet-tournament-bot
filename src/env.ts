...
const DISCORD_REGION_CHANNELS = process.env.DISCORD_REGION_CHANNELS || ""

const REGION_FETCH_DELAY_SECONDS = parseInt(process.env.REGION_FETCH_DELAY_SECONDS || "5", 10)
